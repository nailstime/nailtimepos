...
export default function Catalog() {
  ...
  const Row = ({ it, table, isProduct }) => {
    ...
    {editing && <form onSubmit={saveEdit} className="border-b border-mist bg-porcelain/65 px-3 py-4 sm:px-4">
      <div className={"grid gap-3 sm:grid-cols-2 xl:items-end " + (isProduct ? "xl:grid-cols-[minmax(180px,1fr)_160px_140px]" : "xl:grid-cols-[minmax(180px,1fr)_160px_140px_120px]")}>
