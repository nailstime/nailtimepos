...
export default function LiffBooking() {
  ...
  async function confirmBooking() {
    ...
    if (normalizedPhone.length !== 10) {
      setError('กรุณากรอกเบอร์โทรศัพท์ 10 หลัก เพื่อให้ร้านติดต่อยืนยันคิวได้')
      return
    }
